...
from src.hrms.employee_manager import *
from src.hrms.ticket_manager import *
from src.hrms.meeting_manager import *
from src.hrms.leave_manager import *
...
# mcp has tools,prompts,resources (knowledge)
...
def create_ticket(emp_id: str,item: str, reason: str) -> str:
    ...
    :return: Confirmation message
    """
    ticket_req = TicketCreate(emp_id=emp_id,
                              item=item,
                              reason=reason)
...
@mcp.tools()
def list_tickets(emp_id: str, status: str) -> str:
    """
...
def schedule_meeting(employee_id: str, meeting_datetime: datetime, topic: str) -> str:
    ...
    :return: Confirmation message
    """
    meeting_req = MeetingCreate(emp_id=employee_id,
...
def cancel_meeting(employee_id: str, meeting_datetime: datetime, topic: str) -> str:
    ...
    meeting_req = MeetingCancelRequest(emp_id=employee_id,
                                       meeting_dt=meeting_datetime,
                                       topic=topic)
...
@mcp.tool()
def apply_leave(emp_id: str) -> str:    
    """
