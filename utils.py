...
if __name__ == "__main__":
    ...
    logger.info(f"Seeded {result['employees']} employees")
    logger.info(f"Seeded {result['leave_records']} leave records")
    logger.info(f"Seeded {result['meetings']} meetings")
    logger.info(f"Seeded {result['tickets']} tickets")
